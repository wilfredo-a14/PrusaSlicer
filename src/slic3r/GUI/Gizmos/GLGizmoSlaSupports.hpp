...
public:
    ...
    std::string get_gizmo_entering_text() const override { return _u8L("Entering support points"); }
    std::string get_gizmo_leaving_text() const override { return _u8L("Leaving support points"); }
